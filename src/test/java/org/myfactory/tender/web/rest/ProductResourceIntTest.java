...
public class ProductResourceIntTest {
    ...
    private static final String DEFAULT_SPEC = "AAAAAAAAAA";
    private static final String UPDATED_SPEC = "BBBBBBBBBB";
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getMake()).isEqualTo(DEFAULT_MAKE);
        assertThat(testProduct.getModel()).isEqualTo(DEFAULT_MODEL);
        assertThat(testProduct.getQty()).isEqualTo(DEFAULT_QTY);
        assertThat(testProduct.getHsnCode()).isEqualTo(DEFAULT_HSN_CODE);
        assertThat(testProduct.getPrice()).isEqualTo(DEFAULT_PRICE);
        assertThat(testProduct.getSpec()).isEqualTo(DEFAULT_SPEC);
    }
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].hsnCode").value(hasItem(DEFAULT_HSN_CODE.toString())))
            .andExpect(jsonPath("$.[*].price").value(hasItem(DEFAULT_PRICE.doubleValue())))
            .andExpect(jsonPath("$.[*].spec").value(hasItem(DEFAULT_SPEC.toString())));
    }
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.hsnCode").value(DEFAULT_HSN_CODE.toString()))
            .andExpect(jsonPath("$.price").value(DEFAULT_PRICE.doubleValue()))
            .andExpect(jsonPath("$.spec").value(DEFAULT_SPEC.toString()));
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getMake()).isEqualTo(UPDATED_MAKE);
        assertThat(testProduct.getModel()).isEqualTo(UPDATED_MODEL);
        assertThat(testProduct.getQty()).isEqualTo(UPDATED_QTY);
        assertThat(testProduct.getHsnCode()).isEqualTo(UPDATED_HSN_CODE);
        assertThat(testProduct.getPrice()).isEqualTo(UPDATED_PRICE);
        assertThat(testProduct.getSpec()).isEqualTo(UPDATED_SPEC);
    }
